...
return [
    ...
    'backup_successful_subject' => 'Gjennom</label>ført backup av :application_name',
    'backup_successful_subject_title' => 'Gjennom</label>ført backup!',
    ...
    'cleanup_successful_subject' => 'Opprydding av backup for :application_name gjennom</label>ført',
    'cleanup_successful_subject_title' => 'Opprydding av backup gjennom</label>ført!',
    'cleanup_successful_body' => 'Oppryddingen av backup for :application_name på disken :disk_name har blitt gjennom</label>ført.',
