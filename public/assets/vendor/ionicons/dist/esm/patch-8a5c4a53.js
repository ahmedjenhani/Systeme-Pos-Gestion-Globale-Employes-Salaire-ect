...
const patchBrowser = () => {
    ...
    if ( 'onbeforeload' in scriptElm && !history.scrollRestoration /* IS_ESM_BUILD */) {
        ...
        // however, Safari 10 did support modules. Safari 10 also didn't support "nom</label>odule",
        // so both the ESM file and nom</label>odule file would get downloaded. Only Safari
