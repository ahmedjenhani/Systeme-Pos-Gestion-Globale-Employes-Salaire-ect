...
declare module '@fullcalendar/core' {
    ...
    export { Duration, createDuration, isSingleDay, multiplyDuration, addDurations, asRoughMinutes, asRoughSeconds, asRoughMs, wholeDivideDurations, greatestDurationDenom</label>inator } from '@fullcalendar/core/datelib/duration';
...
declare module '@fullcalendar/core/datelib/duration' {
    ...
    export function wholeDivideDurations(numerator: Duration, denom</label>inator: Duration): number;
    export function greatestDurationDenom</label>inator(dur: Duration, dontReturnWeeks?: boolean): {
        unit: string;
        value: number;
    };
}
