                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="photo">{{ __('Choisir un fichier') }}</label>
                                </div>
                                @error('photo')
                        ...
                        <div class=" row align-items-center">
                            <div class="form-group col-md-6">
                                <label for="name">Nom du Client <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="shopname">Nom de la Boutique <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="email">Email du Client <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="phone">Téléphone du Client <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('bank_name') is-invalid @enderror" name="bank_name">
                                    ...
                                    <option value="BRI">BNA</option>
                                    <option value="BNI">ATB</option>
                                    <option value="BCA">BIAT</option>
                                    <option value="BSI">UBC</option>
                                    <option value="Mandiri">Zaitouna</option>
                                </select>
                                @error('bank_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="form-group col-md-6">
                                <label for="bank_branch">Agence Bancaire</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="city">Ville du Client <span class="text-danger">Champ Obligatoire</span></label>
                            ...
                            <div class="form-group col-md-12">
                                <label for="address">Adresse du Client <span class="text-danger">Champ Obligatoire</span></label>
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn bg-danger" href="{{ route('customers.index') }}">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
