                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="city">Ville du Client <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-12">
                                <label for="address">Adresse du Client <span class="text-danger">*</span></label>
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn bg-danger" href="{{ route('customers.index') }}">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>
