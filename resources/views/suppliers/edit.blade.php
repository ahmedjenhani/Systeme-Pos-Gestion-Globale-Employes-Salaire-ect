                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="email">Email du fournisseur <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="phone">Téléphone du fournisseur <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="city">Ville du fournisseur <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="type">Type de fournisseur <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-12">
                                <label for="address">Adresse du fournisseur <span class="text-danger">*</span></label>
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary mr-2">Mise à jour</button>
                            <a class="btn bg-danger" href="{{ route('suppliers.index') }}">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>
