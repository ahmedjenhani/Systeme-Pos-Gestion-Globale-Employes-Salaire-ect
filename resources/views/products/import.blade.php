            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Importer des Produits</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="upload_file" id="label_input">Choisir un fichier (.xls / .xlsx)</label>
                                </div>
                                @error('upload_file')
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary mr-2">{{ __('Importer') }}</button>
