                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="product_image">{{ __('Choisir un fichier') }}</label>
                                </div>
                                @error('product_image')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_garage">Garage à produits</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_store">Magasin à produits</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="selling_price">Prix de vente <span class="text-danger">*</span></label>
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary mr-2">{{ __('Enregistrer') }}</button>
                            <a class="btn bg-danger" href="{{ route('products.index') }}">{{ __('Annuler') }}</a>
                        </div>
                    </form>
                </div>
            </div>
