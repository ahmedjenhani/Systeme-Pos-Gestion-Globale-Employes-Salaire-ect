            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Modifier l'employé</h4>
                    </div>
                </div>
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="email">Email de l'Employé <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="phone">Téléphone de l'Employé <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="experience">Expérience de l'Employé</label>
                                <select class="form-control" name="experience">
                                    <option value="">Sélectionner l'année..</option>
                                    <option value="1 Year" @if(old('experience', $employee->experience) == '1 Year')selected="selected"@endif>1 An</option>
                            ...
                            <div class="form-group col-md-6">
                                <label for="salary">Salaire de l'Employé <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="vacation">Vacances de l'Employé</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="city">Ville de l'Employé <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-12">
                                <label for="address">Adresse de l'Employé <span class="text-danger">*</span></label>
